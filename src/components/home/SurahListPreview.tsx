...
const surahPreview = [
  ...
  { number: 2, name: 'Al-Baqarah', arabicName: 'البقرة', verses: 286, type: 'Medeni' },
  { number: 3, name: 'Al-Imran', arabicName: 'آل عمران', verses: 200, type: 'Medeni' },
  { number: 4, name: "An-Nisa", arabicName: 'النساء', verses: 176, type: 'Medeni' },
];
    ...
    <div className="px-5 py-4">
      ...
      >
        {surahPreview.map((surah, index) => (
          ...
          >
            {/* Number badge */}
            <div className="w-10 h-10 rounded-xl icon-box flex items-center justify-center text-sm font-bold text-primary">
              {surah.number}
            </div>
            ...
            {/* Decorative star */}
            <div className="islamic-star opacity-50" />
          </motion.button>
        ))}
      </motion.div>
    </div>
